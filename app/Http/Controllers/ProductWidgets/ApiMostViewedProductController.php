...
class ApiMostViewedProductController extends Controller
{
    ...
    /**
     * @OA\Get(
     *     path="/api/most-viewed-products",
     *     operationId="getMostViewedProducts",
     *     tags={"Most Viewed Products"},
    ...
    public function index(Request $request)
    {
        ...
        $query = MostViewedProduct::with('product.images')->orderBy('order', 'asc');
    ...
    /**
     * @OA\Get(
     *     path="/api/most-viewed-products/{id}",
     ...
     *         @OA\JsonContent(
     *             @OA\Property(property="id", type="integer", description="Most-viewed product ID", example=1),
     ...
     *                 @OA\Property(property="main_image", type="string", description="URL of the main product image", example="http://example.com/storage/images/products/image.jpg")
     *             ),
     *             @OA\Property(property="order", type="integer", description="Display order of the most-viewed product", example=1),
