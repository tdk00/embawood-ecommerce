...
class ApiSpecialOfferProductController extends Controller
{
    /**
     * @OA\Get(
     *     path="/api/special-offer-products",
    ...
    /**
     * @OA\Get(
     *     path="/api/special-offer-products/{id}",
     ...
     *         @OA\JsonContent(
     *             @OA\Property(property="id", type="integer", description="Special offer product ID", example=1),
     ...
     *                 @OA\Property(property="main_image", type="string", description="URL of the main product image", example="http://example.com/storage/images/products/image.jpg")
     *             ),
     *             @OA\Property(property="order", type="integer", description="Display order of the special offer product", example=1),
