                ...
                <!--begin::Aside column-->
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        ...
                        <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-n2">
                            ...
                            <!--end:::Tab item-->
                            <li class="nav-item">
                                <a  target="_blank" class="nav-link text-active-primary pb-4" href="{{  route('admin.products.images.index', $product->id) }}">Şəkillər</a>
                            </li>
                            <!--end:::Tab item-->
                            <!--begin:::Tab item-->
                            <li class="nav-item">
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input type="text" name="meta_title_az" class="form-control mb-2" placeholder="Meta Title (AZ)"
                                                       value="{{ old('meta_title_az', $product->translations->where('locale', 'az')->first()->meta_title ?? '') }}" />
                                            </div>

                                            <div class="mb-10 fv-row">
                                                <label class="form-label">Meta Description (AZ)</label>
                                                <textarea name="meta_description_az" class="form-control mb-2" placeholder="Meta Description (AZ)">{{ old('meta_description_az', $product->translations->where('locale', 'az')->first()->meta_description ?? '') }}</textarea>
                                            </div>

                                            <div class="mb-10 fv-row">
                                                <label class="form-label">Meta Title (EN)</label>
                                                <input type="text" name="meta_title_en" class="form-control mb-2" placeholder="Meta Title (EN)"
                                                       value="{{ old('meta_title_en', $product->translations->where('locale', 'en')->first()->meta_title ?? '') }}" />
                                            </div>

                                            <div class="mb-10 fv-row">
                                                <label class="form-label">Meta Description (EN)</label>
                                                <textarea name="meta_description_en" class="form-control mb-2" placeholder="Meta Description (EN)">{{ old('meta_description_en', $product->translations->where('locale', 'en')->first()->meta_description ?? '') }}</textarea>
                                            </div>

                                            <div class="mb-10 fv-row">
                                                <label class="form-label">Meta Title (RU)</label>
                                                <input type="text" name="meta_title_ru" class="form-control mb-2" placeholder="Meta Title (RU)"
                                                       value="{{ old('meta_title_ru', $product->translations->where('locale', 'ru')->first()->meta_title ?? '') }}" />
                                            </div>

                                            <div class="mb-10 fv-row">
                                                <label class="form-label">Meta Description (RU)</label>
                                                <textarea name="meta_description_ru" class="form-control mb-2" placeholder="Meta Description (RU)">{{ old('meta_description_ru', $product->translations->where('locale', 'ru')->first()->meta_description ?? '') }}</textarea>
                                            </div>

                                            <!-- Quill Editor for Description Web in Azerbaijani (AZ) -->
                                            <div class="form-group">
                                                <label for="description_web_az" class="form-label">Veb Təsviri (AZ)</label>
                                                <div id="description_web_az_quill" style="height: 200px;">{!! old('description_web_az', $product->translations->where('locale', 'az')->first()->description_web ?? '') !!}</div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div id="description_web_en_quill" style="height: 200px;">{!! old('description_web_en', $product->translations->where('locale', 'en')->first()->description_web ?? '') !!}</div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div id="description_web_ru_quill" style="height: 200px;">{!! old('description_web_ru', $product->translations->where('locale', 'ru')->first()->description_web ?? '') !!}</div>
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" name="ar_model_url" class="form-control mb-2" placeholder="https://app.tryverse.io/model/viewer/a90351a4-54a6-40ee-bc82-de12d3007250"
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('.module-check-input').change(function () {
                ...
                if ($(this).is(':checked')) {
                    addProductToSelectedList(productId, productName, productPrice, productThumbnail, productRealId, productColor);
                } else {
            ...
            function addProductToSelectedList(productId, productName, productPrice, productThumbnail, productRealId, productColor) {
