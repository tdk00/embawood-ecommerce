                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3">
                            <a href="{{route('admin.products.create')}}" class="menu-link px-3">Yeni Məhsul</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            <a class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#bulkDiscountModal">
                                Toplu endirim tətbiqi
                            </a>
                        </div>
                        <div class="menu-item px-3">
        ...
        $("#bulkDeactivate").on('click', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    fetch('{{ route('admin.products.bulk-deactivate') }}', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'Accept': 'application/json',
