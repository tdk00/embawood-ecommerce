    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <form action="{{ route('admin.purchased-together-products.attach', $product->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-10 fv-row">
                        <label class="required form-label">Select Purchased Together Product</label>
                        <select class="form-select mb-2" name="purchased_together_product_id" data-control="select2" data-placeholder="Məhsul seçin">
                            <option></option>
